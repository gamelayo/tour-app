  ...
  return (
    <div className="destination">
      ...
      <DestinationData
        ...
        text="One of the most iconic vies in Luton, Mt, Taal boasts a volcano inside
          a lake inside an island. If you fancy a closer lock, the hike up to
      ...
      <DestinationData
        ...
        text="If you're looking for a hike that's a little more challenging but still good for a beginner mountaineer, check out Mt.Daguldul in San juan, Batangas. you'll start your hike the beach and pass through tropical forest, different rock formations and small streams. There's a small store halfway up the trail where you can take a break and drink buko juice and though the summit itself may not have the best view the breeze is fantastic. once you've made it back down head straight to the beach for a refreshing well-deserved swim."
        img1={mountain3}
        img2={mountain4}
